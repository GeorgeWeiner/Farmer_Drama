...
{
    [SerializeField] float AttackDmgTemp;
    [SerializeField] float SpeedTemp;
    ...
    protected override void SetNewTempStats(Collider _other)
    {
        ...
        //_other.gameObject.GetComponent<Stats>().AddTempAttackSpeed(AttackDmgTemp);
        _other.gameObject.GetComponent<Stats>().AddTempSpeed(SpeedTemp);
